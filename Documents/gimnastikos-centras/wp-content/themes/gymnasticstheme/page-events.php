			...
			<div class="col-lg-8"><!-- d-inline-block -->
				...
				<!-- ajax .container START
					...
					<div class="container text-center load-more-block">
                    	<div class="btn btn-lg btn-default load-more-posts-button" data-page="1" data-url = "<?php echo admin_url("admin-ajax.php");?>" ><span class="fa fa-spinner loader"></span><span class="button-text">Daugiau<span>
                    	</div>
                	</div>
				<!-- ajax .container END-->
